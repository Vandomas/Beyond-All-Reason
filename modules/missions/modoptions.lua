--- Lives in the game section (the axis's own) so a lobby's mode panel shows it
--- while a preset claims it. Items are discovered at parse time because this
--- file is executed Lua everywhere the option set is read (unitsync, lobby, game).
