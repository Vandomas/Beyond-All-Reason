--- No gadget and no state: placement is a question about the map as it is right now, so there is
--- nothing to own between calls and nothing to get out of sync.
