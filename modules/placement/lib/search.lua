--- Integer lattice rather than sin/cos samples: exact integer arithmetic leaves no floating point for clients or
--- replays to disagree about, and a ring at radius k has a knowable candidate count. Pure (no Spring) so nearest-first, the whole contract, is specced directly.
