--- Transfer applies a received constructor's stand-down when the unit changes hands; the engine
--- asks construction whether a build step is allowed, so the delay is answered here.
