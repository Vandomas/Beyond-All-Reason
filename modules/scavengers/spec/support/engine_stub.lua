--- The SAME stub feeds both the frozen legacy config and lib/defs_build.lua, so any disagreement
--- is a real difference in the port and not in what the two were told about the world.
