...
--- The mode is a serializer and a lobby instruction, never a new wire key: the option names it
--- emits are exactly the eight that already exist, and the bot is carried outside the option set.
