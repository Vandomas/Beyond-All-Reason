...
--- Golden test: the builder proved against a frozen copy of the roster it replaced, both under
--- one stubbed engine so anything they disagree about is a difference in the port.
