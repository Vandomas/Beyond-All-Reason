...
-- Resistance and stagger are scavenger-specific and deliberately left out of the waves module:
-- the boss learns what is hurting it and takes less, which stops one massed unit type being the
-- answer every game; a full stagger bank paralyses it, so burst damage is still rewarded.
...
---On recovery the bank grows a tenth and the window five seconds, so the second stagger costs
---more than the first and the tenth is a real investment.
