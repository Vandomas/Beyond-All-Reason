...
-- Anything the scavengers come to own becomes its purple variant: losing a factory is
-- frightening rather than annoying because it does not change hands, it changes species.
