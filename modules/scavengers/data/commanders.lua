--- Decoys are the point of the pair: a player cannot tell whether killing a commander is worth
--- the detour until it dies, which is what stops commanders being a free bounty.
