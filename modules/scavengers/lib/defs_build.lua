--- Build(opts) is PURE: the modoption snapshot, team list and def tables arrive injected. The old
--- file read them from globals at include time, so it could not be tested, read in a lobby, or built twice.
