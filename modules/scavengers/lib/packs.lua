--- Composition is defined HERE, once, not per mission: a mission that authored its own
--- composition would go stale the first time the roster changed underneath it.
