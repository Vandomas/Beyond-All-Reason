--- Shared by the gadget and mission pressure on purpose: a mission that got a quieter scavengers
--- would not be a test of the scavengers. GG gadgets are checked first: missions lack them.
local Hooks = {}
...
function Hooks.New(config, behaviourByID, counters)
	return {
		...
		---A mission without the boss gadget simply has a boss with no stagger machine.
