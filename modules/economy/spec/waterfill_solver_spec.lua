...
--- The tax rate is the caller's rule (Solve takes taxRateFor); reading the modoption here keeps
--- economy's spec inside economy, since transfer owns tier resolution and tests it itself.
