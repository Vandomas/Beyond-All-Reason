--- One tier scheme, not the definition of tech: a different scheme is another file beside this one, and the mode preset picks which applies.
--- Tech does not decide what a transfer costs, transfer does; tech only decides which tier, and so which _at_tN variant, applies.
