...
ContextFactory.registerPolicyContextEnricher(function(ctx, springRepo, senderTeamID)
	...
	-- Evaluated through the policy rather than inline so the same answer is
	-- available to anything describing a team's tier, including a UI with no game running.
