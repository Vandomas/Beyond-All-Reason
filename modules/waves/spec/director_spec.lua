...
--- The whole lifecycle (grace, first wave, the boss, an endless reloop) is reachable without Spring:
--- burrows that never move, ground that is always land, and a seeded RNG.
