--- Every PvE flavor exposes the same dials under different modoption keys, because those keys are wire
--- values a lobby and a SPADS config already know: this file ships the grammar, the flavor the keys.
