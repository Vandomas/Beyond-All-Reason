...
--- Everything here is plain data: the spec holds NUMBERS resolved once at Start, never modoption reads,
--- and progress lives in state, never in closures.
...
--- The gadget is a dumb executor: every decision, including composition, already happened.
---@alias WaveOrderKind
---| "burrow"
---| "wave"
---| "boss"
