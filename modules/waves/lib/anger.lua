--- techAnger and bossAnger are separate clocks because the roster keeps climbing after the boss is on the field.
--- The integrals a savegame cannot recompute (aggression, its running total, the eco contribution) live only in the state block.
...
---During a boss fight the envelope is scaled back so the boss, not the
---swarm, is the fight.
---@param params WaveParams
