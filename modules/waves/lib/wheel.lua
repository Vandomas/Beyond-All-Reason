--- The wheel is a rotation that never repeats on a fixed period, so a defender cannot set a clock by it.
--- The RNG is injected so a seeded generator makes the whole sequence reproducible under busted.
