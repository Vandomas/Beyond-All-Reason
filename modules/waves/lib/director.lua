--- The spec is IMMUTABLE after New. Everything the monolith mutated on its config lives in
--- `state.params`, a copy made here, and progress lives in `state`, which is exactly the pile a savegame writes.
