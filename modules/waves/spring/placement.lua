--- A PORT kept deliberately close to the monolith so a playtester recognises the placements; its file-level
--- globals now arrive as `state`, which makes it saveable and re-entrant per director. Nothing above spring/ may include this file.
