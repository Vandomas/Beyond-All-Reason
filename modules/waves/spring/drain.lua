--- A PORT, kept as it was: the five-frame trickle is what stops a forty-unit wave freezing the frame it lands on,
--- and the expanding-square probe is what lets a burrow boxed in by wreckage still spawn instead of silently failing.
