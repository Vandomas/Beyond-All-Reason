--- A PORT: the scaling curve and the two-mode placement (on creep where the flavor has creep, in the
--- director's own line of sight where it does not) are the monolith's.
