--- Every key here already means what it means to a lobby and a SPADS config: the preset does not invent
--- a mode option, it SERIALIZES the ones there are. The queen is the flavor's boss, which is the whole translation.
