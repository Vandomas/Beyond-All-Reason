--- Every key, default, item and section weight is EXACTLY what it was in the root file: they are wire values a lobby, SPADS config and saved setup address by name.
--- `mode_category` hands the section to the game axis; nothing in the game reads the selector, raptors activate on a RaptorsAI being present, which keeps every existing lobby working.
