--- The raptor_* options are WIRE VALUES a lobby, SPADS config and saved setup address by name: moving them
--- into the module may change where they live and nothing else, plus the governance pair handing the section to the game axis.
