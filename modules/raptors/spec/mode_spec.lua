...
--- The mode is a serializer and a lobby instruction, never a new wire key. The queen is the flavor's boss;
--- everything else reads like the scavengers preset, which is the point of the shared PvE grammar.
